...
<nav class="bg-white-lautfm ">
<div class="max-w-6xl mx-auto bg-white-lautfm border-b border-gray-licht z-50 sticky top-0">
...
<!--secondary nav-->
<div class="flex items-center space-x-1 text-xl font-light">

  <a href="" class="py-6 px-1 text-gray-600 font-bold">about</a>
  <a href="" class="py-2 px-4 text-gray-600 bg-orange-odessa hover:bg-orange rounded">donate</a>
</div>
